...
// Time Complexity : O(2^(min(n1, n2)))
// Space Complexity : O(min(h(tree1), h(tree2))))
...
public:
    bool isIsomorphic(Node *root1, Node *root2) {
        ...
        bool notSwapped = isIsomorphic(root1->left, root2->left) && isIsomorphic(root1->right, root2->right);
