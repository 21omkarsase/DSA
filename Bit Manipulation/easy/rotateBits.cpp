...
// Rotate Bits
// BasicAccuracy: 37.7%Submissions: 10222Points: 1
// Lamp
...
{
public:
    unsigned short int leftRotation(int n, int d)
    {
        d = d % 16;
        unsigned short int a = n << d;
        unsigned short int b = n >> (16 - d);
        return (a | b);
    }
    unsigned short int rightRotation(int n, int d)
    {
        d = d % 16;
        unsigned short int a = n >> d;
        unsigned short int b = n << (16 - d);
    ...
    {
        vector<int> ans;
        ans.push_back(leftRotation(n, d));
        ans.push_back(rightRotation(n, d));
        return ans;
    }
};
